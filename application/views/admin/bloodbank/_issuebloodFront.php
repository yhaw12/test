  ...
  <div class="row">
    ...
    <div class="col-sm-3">
        <div class="form-group">
            ...
            <div>
                <select name='consultant_doctor' style="width:100%;" id="consultant_doctor"  class="form-control select2"  style="width:100%">
    ...
    <div class="col-sm-3">
        <div class="form-group">
            ...
            <select  style="width: 100%" class="form-control select2 component_issue" id="blood_group_issue_select" disabled readonly>
                <option value=""><?php echo $this->lang->line('select'); ?></option>
                <?php
