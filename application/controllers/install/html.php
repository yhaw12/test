...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div id="loading">
<img src="<?php echo base_url('backend/images/installation.gif') ?>" />
<div> Please wait installation is under process...</div>
</div>
                ...
                <div class="col-md-12 m1">
                    ...
                    <div class="col-md-9 col-sm-9">
                        <div class="newbox new-box-primary">
                            ...
                            <?php } else if ($step == 3) { ?>
                                <?php 
                                    $attributes = array( 'id' => 'final_submit');
                                ...
                                <div class="text-right">
                                    <button type="button" class="btn btn-primary install_btn" >Begin Install</button>
                                </div>
                                <?php echo form_close(); ?>
                            <?php } else if ($step == 4) { ?>
								...
								<ol style="list-style: disc; margin-left: 15px;">
								<li><span style="color: #0084B4; padding-right: 5px;"><?php echo base_url(); ?>site/login</span> Admin Panel : this panel is used for staff like                 
                                superadmin, admin, doctor, pharmacist, pathologist, radiologist, accountant, receptionist, nurse login.                           
...
<script type="text/javascript">
    $(document).ready(function(){      
      $(document).on('click','.install_btn',function(e){
